...
export default function Registro() {
  ...
  return (
    <>
      <Navbar />
      <section className="min-h-screen bg-fondoLogin bg-bottom bg-no-repeat bg-contain gap-6 flex flex-col justify-center items-center center ">
        <div className="bg-azulClaro bg-opacity-80 w-[80%] flex flex-col justify-center items-center min-h-screen rounded-2xl gap-6 m-20 sm:pt-20 sm:pb-20 sm:w-[70%] md:w-[50%] lg:w-[40%] xl:w-[30%]" >
          ...
          <form className="flex flex-col justify-center items-center font-OpenSans gap-5 w-[80%] sm:gap-8">
            ...
            <button onClick={handleRegister} className="bg-verde p-3 text-xl rounded-xl sm:p-4 2xl:text-3xl 2xl:p-5 ur:p-6 bg-azulOscuro text-white">
              Registrarse
            </button>
